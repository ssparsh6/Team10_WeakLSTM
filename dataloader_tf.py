...
This dataloader has been modified by Team_10 to use for sequence batches
...
class CholecT50():
    ...
    def split_selector(self, case='cholect50'):
        switcher = {
            'cholect50': {
                'train': [1, 4, 15, 26, 40, 52, 65, 79, 2, 18, 27, 43, 56, 66, 92, 22, 31, 47, 57, 68, 96, 5, 23, 35, 48, 60, 70, 103, 13, 25, 36, 49, 62, 75, 110],
                'val'  : [8, 12, 29, 50, 78],
    ...
    def generator(self, records):
        for record in records:
            ...
            uframes    = list(label_data.keys())
            
            uframes = list(map(int, uframes))
            uframes.sort()
            ...
            for frame in uframes:
                ...
                img_path = os.path.join(video_path, "{:0>6}.png".format(frame))
